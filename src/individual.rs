...
impl Individual {
    ...
    fn init_mst(rgb_image: &image::RgbImage, distance_map: &Vec<Vec<Vec<Vec<f64>>>>) -> Genome {
        ...
        while unseen_pixels.len() > 0 {
            ...
            if
                mst_element.row > 0 &&
                unseen_pixels.contains(&(mst_element.row - 1, mst_element.column))
            {
                mst.push(MSTelement {
            ...
            if
                mst_element.row < (rgb_image.height() as usize) - 1 &&
                unseen_pixels.contains(&(mst_element.row + 1, mst_element.column))
            {
                mst.push(MSTelement {
                    row: mst_element.row + 1,
            ...
            if
                mst_element.column > 0 &&
                unseen_pixels.contains(&(mst_element.row, mst_element.column - 1))
            {
                mst.push(MSTelement {
                    row: mst_element.row,
            ...
            if
                mst_element.column < (rgb_image.width() as usize) - 1 &&
                unseen_pixels.contains(&(mst_element.row, mst_element.column + 1))
            {
                mst.push(MSTelement {
                    row: mst_element.row,
